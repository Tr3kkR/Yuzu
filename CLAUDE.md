...
Canonical defaults (`needs-triage`, `needs-info`, `ready-for-agent`, `ready-for-human`, `wontfix`); all five now exist in the repo's label set. See `docs/agents/triage-labels.md`.
