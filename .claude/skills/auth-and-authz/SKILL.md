...
6. **SAML 2.0 SP** — thin first slice shipped, **plus group→role mapping**
   ...
   `--saml-group-attribute`, Windows support, IdP-metadata auto-fetch (the
