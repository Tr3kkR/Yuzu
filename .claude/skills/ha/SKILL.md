...
**WS-6 re-stamped 2026-09-23 (branch `feat/ha-ws6-61-crl-publish`):** slice 6.1 (cross-replica
CRL publication, #4126) in progress; 6.1b / 6.2 / 6.3 planned; operator decisions D1 (shared key
custody, not `SecretCodec`) and D2 (one-time `.cfg` enrollment import) recorded in ADR-2002 §8.
