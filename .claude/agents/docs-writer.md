...
that means item 6: open the three routed-concern tables (`.claude/routed-concerns.md`, `.claude/routed-concerns-access-control.md`, `.claude/routed-concerns-security-posture.md`) and confirm a row names the
