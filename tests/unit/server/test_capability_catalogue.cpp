...
#include "capability_decls/plugin_action_catalogue_ssh_hardening.hpp"
...
[[nodiscard]] std::vector<LabeledSpan> all_labeled_sources() {
    return {
        ...
        {"ssh_hardening", capdecls::plugin_action_catalogue_ssh_hardening(), false},
...
[[nodiscard]] CommandCapabilityRegistry build_registry(const std::vector<LabeledSpan>& sources) {
    ...
    // literally, eleven sources exactly as a live composition site would use.
    return CommandCapabilityRegistry{
        ...
        capdecls::plugin_action_catalogue_ssh_hardening(),
