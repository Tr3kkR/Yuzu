...
// composed from the same eleven capability-declaration spans the production site
...
// copy of the eleven-span composition is the drift a shared seam exists to
