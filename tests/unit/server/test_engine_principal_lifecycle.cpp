...
TEST_CASE("ApiTokenStore::sweep_expired_rotations: auto-revokes an elapsed "
    ...
    auto predecessor_before = tokens->get_token(predecessor_id);
    ...
    auto predecessor_row = tokens->get_token(predecessor_id);
    ...
    auto successor_row = tokens->get_token(successor_id);
