...
# core_dispatch_capabilities=4, content_dist=5, a=45, b=55, c=34, d=42,
# disk_actions=2, filesystem_posture=3, power_health=4, autoruns=2,
# windows_optional_features=2, ssh_hardening=1 — see command_capability.hpp's
# fragment doc comments and the #1398 design doc's verified row-count audit.
