...
// The wire-stability StatusCode<->proto static_assert block moved to
// transport/src/transport_static_assert.cpp (#376 PR 3) so it is
// asserted exactly once regardless of which backend(s) are linked.
