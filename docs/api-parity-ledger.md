...
Registered `/api/v1/*` routes: 174. OpenAPI `paths` entries: 173. Missing from OpenAPI: 1 (1 carried in `check-api-parity.py`'s `ALLOWLIST_OPENAPI_MISSING` pending F2, 0 unallowlisted). MCP tools: 91.
