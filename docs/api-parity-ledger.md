...
Registered `/api/vN/*` routes: 224. OpenAPI `paths` entries: 223. Missing from OpenAPI: 1 (1 carried in `check-api-parity.py`'s `ALLOWLIST_OPENAPI_MISSING` pending F2, 0 unallowlisted). MCP tools: 143.
