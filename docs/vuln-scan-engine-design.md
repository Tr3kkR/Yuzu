...
| **Decisions of record** | ADR [0001](adr/0001-observed-grounded-reachability.md) · [0002](adr/0002-reachability-graph-data-model.md) · [0003](adr/0003-telemetry-capture-model.md) · [0004](adr/0004-server-storage-substrate.md) · [0005](adr/0005-attack-path-and-chokepoint-scoring.md) · [0022](adr/0022-headless-platform-use-case-engines.md) · [0023](adr/0023-vulnerability-correlation-engine.md) · [4001](adr/4001-vulnerability-dashboard-attack-path-explorer.md) (placement — see reconciliation note below) |
...
> server capability. The in-server vuln stack is **absorbed into ADR-0022
...
> in `docs/adr-0022-execution-plan.md` § "Relationship to ADR-0023 and ADR-4001"
...
- **ADR-0022** — Headless platform / use-case engines (this doc's server-side placement is
  interim — grandfathered surface #2; see the reconciliation note at the top).
- **ADR-0023** — Vulnerability correlation engine (in-server, absorbed-interim under ADR-0022).
- **ADR-4001** — Vulnerability dashboard + Attack Path Explorer (in-server lens,
  absorbed-interim under ADR-0022; ADR-4002's scoring substrate not absorbed).
