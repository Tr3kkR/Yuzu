...
- Revisit trigger: before the F14 flip, per #3953's own acceptance criteria (each residual
  resolved or explicitly risk-accepted) - this entry IS that risk-accept, pending #3972's fix.
