...
| This PR | PR-1 of 7: PR-1 (this doc) → PR-2a (#2233 items 1/4/6 + #3831 batch, #3847) → PR-2c (fault-injection seams + item-9 TSan rerun, #3848) → [PR-2d, contingency only, if PR-2c's seams demonstrate a real defect - resolves before PR-5, per §5's risk register] → PR-4 (promtool CH-2/CH-5-PROM) → PR-5 (the flip) → PR-6 (evidence closeout). PR-3 (#2233 item 8) was dropped before this doc was written - item 8 moved to the P3 lane (§3 row 8). PR-2b (item 5) is dropped by this doc (§3 row 5). |
