...
| **Epistemic** | verified against this branch's HEAD (#3816's exactly-once clause + `abandoned`/`abandonment_cleanup_failures` counters added post-`b16e5836d`, on `fix/3816-guardian-io-executor-abandonment-signal`) |
