...
| system_hardening | posture | linux | supported | 1 | allowlisted /proc/sys reads (open/read, errno-classified absent/unreadable; a missing key is absent only when statfs confirms its directory is procfs) | - |
