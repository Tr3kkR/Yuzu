...
The session-lifecycle + transport pre-check half of the Streamable HTTP transport is **live** (ADR-0022 execution plan **Decision 15 / track 2f** PR 1). Shipped:
