...
> → `193 25 47 265`. Tier tallies (`Foundation`=T1, `Advanced`=T2, `Future`=T3) add the same
...
─────────────────────────────────────────────────────────────────
Overall      [=======================---------]  193/265 done (73%) (25 partial)
```
