...
| PR 1c-4 | Agent-side Subscribe (bidi) + DownloadUpdate (server-stream-via-bidi) lift; UP-14 hard predecessor closed by #904 (bounded dispatcher pool, 2026-05-09); remaining hard predecessor: #902 DownloadUpdate idle-read deadline | Pending |
