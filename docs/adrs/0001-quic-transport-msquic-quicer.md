...
| PR 1c-4 | Agent-side Subscribe (bidi) + DownloadUpdate (server-stream-via-bidi) lift; all hard predecessors closed: UP-14 by #904 (bounded dispatcher pool, 2026-05-09), UP-8 by #902 (BidiStream::read idle-read deadline, 2026-05-09), `parse_target_address` agent-side test by `1af8ab5`, Heartbeat per-cycle `stop_source` round-trip test by `tests/unit/test_heartbeat_cancel_pattern.cpp` (3 tests, 2026-05-09) | Pending (ready to plan) |
