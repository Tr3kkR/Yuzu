...
`ScheduleRunner`'s approval-gated fan-out (D3 in that header) is unchanged by this addition: an
approved scheduled forensics read remains permitted by the schedule-approval posture, not by this
gate.
