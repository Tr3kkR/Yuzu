...
The fleet-visualization feature ladder lands across PRs 1–11 of the `feat/viz-engine` branch. PR 5 ships the page scaffold + camera controls; PRs 6–10 add machines / processes / edges / vuln overlay; PR 11 ships polish (LOD, edge bundling, a11y, perf).
