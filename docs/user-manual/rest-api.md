...
| PUT | `/api/v1/guaranteed-state/baselines/` | 4 MiB | `guardian_benchmark_authoring` | Benchmark catalog imports and decision saves; bounded JSON metadata, with no deployment side effect. |
