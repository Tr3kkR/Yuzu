...
| `ssh_hardening` | ⛔ ⛔ ✅ | SSH server hardening audit -- checks sshd_config KexAlgorithms/Ciphers/MACs/HostKey against the Mozilla Modern OpenSSH baseline | [README](../../agents/plugins/ssh_hardening/README.md) |
