...
54 of 54 plugins document themselves this way; the rest are described in the prose below until their README lands.
...
| `cert_scan` | ✅ ✅ ✅ | SSL/TLS certificate and private-key discovery -- walks every local user's home directory for certificate material, CSRs, and private keys that escaped managed custody. Never emits raw key material, only structural metadata. | [README](../../agents/plugins/cert_scan/README.md) |
