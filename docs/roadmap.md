...
> **Since the pin (re-verified against dev @ `c7f3a5bed`, 2026-09-13):** WS-10 is **done** (#4092, merged 2026-09-07). WS-3 3.2 (#4134, the elector now gates singleton background loops), 3.3 (#4169, durable command outbox) and 3.4 (#4194, remediation CAS) are **done**, and WS-4 slice 4.1 (fenced `GatewayRouteStore`, #4245) is done but **inert** — nothing reads it for dispatch until 4.2. `docs/ha-delivery-matrix.md` is the live record. Live active-active HA is still not delivered.
