...
**Capability:** 24.4 | **Scope:** Server | **Status:** Open — **partially superseded by ADR-0022**

> **ADR-0022 note:** the consumer auth/token model described below (scoped API
> tokens, rate limits, consumer identity) is absorbed into ADR-0022's **engine
> principals** (see `docs/adr/0022-headless-platform-use-case-engines.md`
...
> **not** addressed by ADR-0022 and remain open under this issue.
...
**Capability:** new | **Scope:** Server (auth) | **Status:** Proposed — **absorbed into the ADR-0022 auth follow-up**

> **ADR-0022 note:** this issue's substance (a machine principal type with
...
> Phase 4 — see `docs/adr-0022-execution-plan.md`). Do not implement it
...
> **ADR-0022 note:** compliance-framework mappings are interpretation baked
...
> **ADR-0022 note:** joins fleet data with external domain data — re-evaluate
