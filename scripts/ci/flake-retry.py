...
def _selftest():
    ...
    check(("~[pg][auth],~[pg][mcp]",) in _shard_specs
          ...
          in _shard_specs,
          "meson.build: all twelve shard tag filters extracted verbatim")
