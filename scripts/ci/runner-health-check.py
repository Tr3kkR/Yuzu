...
def write_control_failure(expected: dict[str, Any], result: QueryResult) -> None:
    ...
    for pool in ("linux", "bigtam", "windows"):
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.mode == "preflight":
        ...
        pool_members = {
            ...
            "windows": windows_pool_members(expected),
        }
        pool_health = {
        ...
        write_output("windows_pool_healthy", "true" if pool_health["windows"] else "false")
