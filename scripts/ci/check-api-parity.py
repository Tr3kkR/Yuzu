...
#
# #4033 (devices/management-group read-twin batch, #2146 API-parity Batch A)
# flips the devices-domain rows (list/detail/live-snapshot/properties) plus
# the management-group agent-count-preview row from "planned:#2146" to
# "twinned", on top of origin/dev's own already-merged #4027/#4028/#4029/
# #4030/#4031 twins (246) -- reconciled post-merge against the actual
# measured count below, not hand-added from either side's stale pre-merge
# value.
BASELINE_UNTWINNED = 242
