...
usage() {
    ...
    echo ""
    echo "NOT COVERED by this script: the PostgreSQL database (pg_restore)"
    echo "and the CA/keys directory — restore those TOGETHER per"
    echo "docs/user-manual/server-admin.md (ADR-0010 restore-pairing)"
