// Auto-generated embedded HTML for the chargen web UI.
// Kept in a separate header to work around MSVC raw-string-literal
// preprocessing issues with long embedded strings containing braces.
#pragma once

namespace yuzu::server::detail {

// NOLINTBEGIN(cert-err58-cpp)
inline constexpr const char* kIndexHtml = R"HTM(<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
