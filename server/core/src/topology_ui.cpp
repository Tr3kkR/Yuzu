...
.os-seg{display:flex;align-items:center;justify-content:center;font-size:.7rem;font-weight:600;color:#fff}
.os-win{background:#0078d4}.os-linux{background:#e95420}.os-darwin{background:#555}
...
<div hx-get="/frag/topology-data" hx-trigger="load, every 30s" hx-swap="innerHTML">
  <p style="color:#94a3b8">Loading topology...</p>
</div>
</body>
</html>)html";
