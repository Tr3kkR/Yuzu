...
export const PLUGIN_ENTRIES = [
  ...
  { file: 'agents/plugins/browser_inventory/README', slug: 'plugins/browser_inventory', title: 'browser_inventory' },
  ...
  { file: 'agents/plugins/privacy_permissions/README', slug: 'plugins/privacy_permissions', title: 'privacy_permissions' },
